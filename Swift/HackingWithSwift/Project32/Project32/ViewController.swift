...
//  Project32
//
//  Created by Andrew Miotke on 10/25/17.
...
class ViewController: UITableViewController {
    ...
    func index(item: Int) {
        ...
        let item = CSSearchableItem(uniqueIdentifier: "\(item)", domainIdentifier: "com.hackingwithswift.com", attributeSet: attributeSet)
