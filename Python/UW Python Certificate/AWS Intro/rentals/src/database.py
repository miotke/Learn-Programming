...
Updloads .csv files to AWS Dynamo to access the files within the
AWS console.
The actual AWS work is handled in dynamo.py
This file uses Mongodb and is using .csv files and data from lesson05 in the
220 Programming with Python UW class
"""
